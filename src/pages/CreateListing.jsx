        ...
        <main className='max-w-md px-2 mx-auto '>
             ...
             <form >
                    ...
                    <div className='flex'>
                        ...
                        hover:shadow-lg focus:shadow-lg active:shadow-lg transition duration ease-in-out w-full ${
                    ...
                    <div className='flex space-x-6 mb-6'>
                        <div>
                            ...
                            className='w-full px-4 py-2 text-xl text-gray-700 bg-white border border-gray-700 rounded transition duration-150
                    ...
                    <div className='flex items-center mb-6'>
                        <div className=''>
                            ...
                            <div className='flex w-full justify-center items-center space-x-6'>
                                ...
                                value={regularPrice} onChange={onChange} min="50" max="40000000" required className='w-full px-4 py-2 text-xl text-gray-700 bg-white border border-gray-300 rounded transition duration-150 ease-in-out focus:text-gray-700 focus:bg-white focus:border-slate-600 text-center' />
                                 {
                                    type === "rent" && (
                                        <div className=''>
                    ...
                    {offer && (
                        ...
                        <div className=''>
                            ...
                            <div className='flex w-full justify-center items-center space-x-6'>
                                ...
                                value={discountedPrice} onChange={onChange} min="50" max="40000000" required={offer} className='w-full px-4 py-2 text-xl text-gray-700 bg-white border border-gray-300 rounded transition duration-150 ease-in-out focus:text-gray-700 focus:bg-white focus:border-slate-600 text-center' />
                                 {
                                    type === "rent" && (
                                        <div className=''>
                                            <p className='text-md w-full whitespace-nowrap'>$ / Month</p>
                    ...
                    <div className='mb-6'>
                        ...
                        <p className='text-gra-600'>The first Image will be the cover (Max 6)</p>
                        <input type="file"
                        id='images'
                        onChange={onChange}
                        accept=".jpg, .png, .jpeg"
                    ...
                    py-3 bg-blue-600 text-white font-medium text-sm uppercase rounded shadow-md hover:bg-blue-700 hover:shadow-lg focus:bg-blue-700 focus:shadow-lg 
